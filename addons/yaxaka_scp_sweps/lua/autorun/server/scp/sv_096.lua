	...
	for i, v in ipairs(player.GetAll()) do
    	local tr = v:GetEyeTrace()
    		if IsValid(tr.Entity) then
    			if (tr.Entity == scp_ply_vars.scp_096_ply) && not (v.scp096_1) && (v:Alive()) && (scp_ply_vars.scp_096_ply ~= v) && (scp_ply_vars.scp_096_ply:IsPlayer()) && (v.Ignore096 ~= true) then
    				if (v.shifrator_attached == false) && (v.Ignore096 == true) then return end
