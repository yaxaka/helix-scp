ITEM.name = "Alpha CR"
ITEM.model = Model("models/eft_props/gear/chestrigs/cr_alpha.mdl")
ITEM.category = "Разгрузочный жилет"
ITEM.description = "Высококачественный разгрузочный жилет Альфа. Полностью отвечает военным стандартам надежности и функциональности. Сочетание интегрированных подсумков и нашитых MOLLE-строп даёт возможность разместить большое количество необходимого снаряжения. Жилет выполнен в виде классического нагрудника (chest rig). В разгрузочных жилетах данного типа все снаряжение располагается в передней и боковых частях, а спинная часть представлена в виде ремней подвеса и регулировки."
ITEM.Jname = "Alpha CR"
ITEM.width = 2
ITEM.height = 3
