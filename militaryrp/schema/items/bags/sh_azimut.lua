ITEM.name = "Azimut"
ITEM.model = Model("models/eft_props/gear/chestrigs/cr_azimut_b.mdl")
ITEM.category = "Разгрузочный жилет"
ITEM.description = "Простая разгрузочная система из нейлона с несъемными подсумками. Позволяет носить достаточно внушительный боезапас в ущерб удобности."
ITEM.Jname = "Azimut B"
ITEM.width = 2
ITEM.height = 3
