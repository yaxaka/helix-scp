ITEM.name = "Spiritus Systems"
ITEM.model = Model("models/eft_props/gear/chestrigs/cr_bank_robber.mdl")
ITEM.category = "Разгрузочный жилет"
ITEM.description = "Сверхкомпактная и легкая разгрузка для максимальной мобильности и комфорта."
ITEM.Jname = "Bank Robber"
ITEM.width = 2
ITEM.height = 3
