ITEM.name = "Belt-A"
ITEM.model = Model("models/eft_props/gear/chestrigs/cr_beld_ab.mdl")
ITEM.category = "Разгрузочный жилет"
ITEM.description = "Это снаряжение было принято на вооружение в 1989 году и использовалось спецподразделениями ГРУ до начала 21 века. Оно оснащено дополнительным поясом Poyas-B, который имеет 10 подсумков для гранат ВОГ."
ITEM.Jname = "BeltAB"
ITEM.width = 2
ITEM.height = 3
