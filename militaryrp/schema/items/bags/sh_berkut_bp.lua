ITEM.name = "Berkut"
ITEM.model = Model("models/eft_props/gear/backpacks/bp_wartech.mdl")
ITEM.category = "Рюкзак"
ITEM.description = "Тактический рюкзак с возможностью фронтальной загрузки. Подходит для использования военными и силами безопасности, а также для военно-тактических игр. Произведено в WARTECH."
ITEM.Jname = "Berkut BP"
ITEM.width = 4
ITEM.height = 4
