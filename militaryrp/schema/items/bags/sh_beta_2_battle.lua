ITEM.name = "ANA Tactical Beta 2 Battle"
ITEM.model = Model("models/eft_props/gear/backpacks/bp_anatactical_beta.mdl")
ITEM.category = "Рюкзак"
ITEM.description = "Легкий и вместительный рюкзак от ANA Tactical. Специально разработан для использования в динамичных условиях и на пересеченной местности."
ITEM.Jname = "Beta 2 Battle BP"
ITEM.width = 5
ITEM.height = 5
