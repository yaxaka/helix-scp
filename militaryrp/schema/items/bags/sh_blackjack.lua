ITEM.name = "Blackjack"
ITEM.model = Model("models/eft_props/gear/backpacks/bp_blackjack.mdl")
ITEM.category = "Рюкзак"
ITEM.description = "Рюкзак для дальних и успешных выездов фирмы Mystery Ranch."
ITEM.Jname = "Blackjack"
ITEM.width = 5
ITEM.height = 5
