ITEM.name = "BlackRock"
ITEM.model = Model("models/eft_props/gear/chestrigs/cr_blackrock.mdl")
ITEM.category = "Разгрузочный жилет"
ITEM.description = "Производимая вручную в ограниченном количестве разгрузка для ношения поверх бронежилета в условиях городских боёв. Прочная и многофункциональная, поддерживает подсумки с креплениями MOLLE и ALICE."
ITEM.Jname = "BlackRock"
ITEM.width = 2
ITEM.height = 3
