ITEM.name = "Dragon Egg MkII"
ITEM.model = Model("models/eft_props/gear/backpacks/bp_dragon_egg_mk2.mdl")
ITEM.category = "Рюкзак"
ITEM.description = "Легкий и универсальный рюкзак объемом более 25 литров, предназначенный для военнослужащих и сотрудников правоохранительных органов."
ITEM.Jname = "Dragon Egg MkII"
ITEM.width = 5
ITEM.height = 5
