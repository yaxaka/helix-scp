ITEM.name = "BSS-MK1"
ITEM.model = Model("models/eft_props/gear/chestrigs/cr_bssmk1.mdl")
ITEM.category = "Разгрузочный жилет"
ITEM.description = "Ременно плечевая система нового поколения, укомплектованная под патрульно-штурмовую работу."
ITEM.Jname = "BSS-MK1"
ITEM.width = 2
ITEM.height = 3
