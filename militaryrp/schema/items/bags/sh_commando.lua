ITEM.name = "Commando"
ITEM.model = Model("models/eft_props/gear/chestrigs/cr_commando_b.mdl")
ITEM.category = "Разгрузочный жилет"
ITEM.description = "Сконструированная для быстрого и легкого доступа, эта разгрузочная система позволит пользователю иметь при себе значительный запас магазинов. Производство BLACKHAWK. Версия в черном цвете."
ITEM.Jname = "Commando Black"
ITEM.width = 2
ITEM.height = 3
