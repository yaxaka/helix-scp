ITEM.name = "CSA CR"
ITEM.model = Model("models/eft_props/gear/chestrigs/cr_cs_assault.mdl")
ITEM.category = "Разгрузочный жилет"
ITEM.description = "Максимально простая разгрузка, сшитая на скорую руку из сомнительных материалов. Предназначена для игры в страйкбол. Военное применение данного образца возможно, но не рекомендуется."
ITEM.Jname = "CSA"
ITEM.width = 2
ITEM.height = 3
