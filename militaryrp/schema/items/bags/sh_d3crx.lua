ITEM.name = "D3CRX"
ITEM.model = Model("models/eft_props/gear/chestrigs/cr_d3crx.mdl")
ITEM.category = "Разгрузочный жилет"
ITEM.description = "Боевой нагрудник Haley Strategic D3CRX является одной из самых почитаемых ЧВК разгрузочных систем. Легкость и простота использования подкрепляется наличием оптимального количества подсумков."
ITEM.Jname = "D3CRX"
ITEM.width = 2
ITEM.height = 3
