ITEM.name = "Drawbridge"
ITEM.model = Model("models/eft_props/gear/backpacks/bp_drawbridge.mdl")
ITEM.category = "Рюкзак"
ITEM.description = "Эргономичный рюкзак среднего размера объемом 25 л с впечатляющим количеством модульных карманов и ремней. Производитель Hazard 4."
ITEM.Jname = "Drawbridge"
ITEM.width = 5
ITEM.height = 5
