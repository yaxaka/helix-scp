ITEM.name = "Спортивная сумка"
ITEM.model = Model("models/eft_props/gear/backpacks/bp_forward.mdl")
ITEM.category = "Рюкзак"
ITEM.description = "Спортивная сумка, которую раньше можно было увидеть у любителей фитнеса или тех, кто ездит на работу на дальние расстояния, теперь является типичным атрибутом."
ITEM.Jname = "Duffle Bag"
ITEM.width = 3
ITEM.height = 3
