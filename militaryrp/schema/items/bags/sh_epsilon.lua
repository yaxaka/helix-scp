ITEM.name = "Защищенный контейнер Эпсилон"
ITEM.model = Model("models/eft_props/secureconts/epsilon.mdl")
ITEM.category = "Контейнер"
ITEM.description = "Очередная разработка компании Terragroup - защищенный контейнер Эпсилон."
ITEM.Jname = "SC Epsilon"
ITEM.width = 4
ITEM.height = 2
