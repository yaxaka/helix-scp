ITEM.name = "F4 Terminator"
ITEM.model = Model("models/eft_props/gear/backpacks/bp_f4terminator.mdl")
ITEM.category = "Рюкзак"
ITEM.description = "Чрезвычайно универсальный полноформатный рюкзак для военного использования. Производитель Eberlestock."
ITEM.Jname = "F4 Terminator"
ITEM.width = 5
ITEM.height = 5
