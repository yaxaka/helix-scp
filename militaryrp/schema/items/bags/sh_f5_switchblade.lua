ITEM.name = "F5 Switchblade"
ITEM.model = Model("models/eft_props/gear/backpacks/bp_f5switchblade.mdl")
ITEM.category = "Рюкзак"
ITEM.description = "Современный, высококачественный, малогабаритный рюкзак для выполнения боевых задач в любых условиях."
ITEM.Jname = "F5 Switchblade"
ITEM.width = 5
ITEM.height = 5
