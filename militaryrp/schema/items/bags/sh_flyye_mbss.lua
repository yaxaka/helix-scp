ITEM.name = "Flyye MBSS"
ITEM.model = Model("models/eft_props/gear/backpacks/bp_mbss.mdl")
ITEM.category = "Рюкзак"
ITEM.description = "Сверхпрочный рюкзак из материала Cordura 1000D с отдельным карманом для питьевой системы и системой крепления MOLLE по бокам."
ITEM.Jname = "Flyye MBSS"
ITEM.width = 4
ITEM.height = 4
