ITEM.name = "Gruppa 99 T30"
ITEM.model = Model("models/eft_props/gear/backpacks/bp_gr99_t30_b.mdl")
ITEM.category = "Рюкзак"
ITEM.description = "Тридцатилитровый штурмовой рюкзак от Gruppa 99. Качественное решение для проведения спецопераций. Черный вариант."
ITEM.Jname = "Gruppa 99 T30 (B)"
ITEM.width = 5
ITEM.height = 5
