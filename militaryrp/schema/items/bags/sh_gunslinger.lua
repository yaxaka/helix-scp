ITEM.name = "Gunslinger"
ITEM.model = Model("models/eft_props/gear/backpacks/bp_g2_gunslinger.mdl")
ITEM.category = "Рюкзак"
ITEM.description = "Это рюкзак среднего размера с ножнами полной ширины для лучшего размещения оружия с большим поперечным сечением или громоздкой оптикой. Широкие ножны также позволяют использовать его в качестве превосходного отделения для ноутбука или военной радиостанции, а поскольку он также широкий в нижней части, пользователи могут носить оружие прикладом вниз или вверх. Производство Eberlestock."
ITEM.Jname = "Gunslinger"
ITEM.width = 5
ITEM.height = 6
