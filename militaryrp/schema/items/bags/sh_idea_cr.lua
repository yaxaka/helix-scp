ITEM.name = "IDEA CR"
ITEM.model = Model("models/eft_props/gear/chestrigs/cr_razgruz_ikea.mdl")
ITEM.category = "Разгрузочный жилет"
ITEM.description = "Кустарная разгрузочная система, выполненная из сумки магазина IDEA. Нельзя сказать, что она надежная и подходит для выполнения широкого спектра военно-тактических задач, но, по крайней мере, это хороший образец бомж-стайла."
ITEM.Jname = "DIY IDEA CR"
ITEM.width = 2
ITEM.height = 3
