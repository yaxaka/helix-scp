ITEM.name = "Защищенный контейнер Kappa"
ITEM.model = Model("models/eft_props/secureconts/kappa.mdl")
ITEM.category = "Контейнер"
ITEM.description = "Засекреченная разработка компании Terragroup - Защищенный контейнер Каппа."
ITEM.Jname = "SC Kappa"
ITEM.width = 3
ITEM.height = 3
