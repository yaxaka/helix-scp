ITEM.name = "Khamelion"
ITEM.model = Model("models/eft_props/gear/chestrigs/cr_zryachii.mdl")
ITEM.category = "Разгрузочный жилет"
ITEM.description = "Простая подвесная система с несъемными подсумками, предназначенная для гранат и магазинов снайперской винтовки СВД. Производство Азимут СпецСнаряжение. Исполнение оливковое."
ITEM.Jname = "Khamelion"
ITEM.width = 2
ITEM.height = 3
