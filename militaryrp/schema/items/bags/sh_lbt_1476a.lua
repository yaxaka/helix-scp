ITEM.name = "LBT-1476A"
ITEM.model = Model("models/eft_props/gear/backpacks/bp_lbt1476a.mdl")
ITEM.category = "Рюкзак"
ITEM.description = "Средний трехдневный рюкзак, предназначенный как для военных, так и для туристических целей. Производитель London Bridge Trading."
ITEM.Jname = "LBT-1476A"
ITEM.width = 4
ITEM.height = 4
