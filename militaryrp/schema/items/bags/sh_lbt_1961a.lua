ITEM.name = "LBT-1961A"
ITEM.model = Model("models/eft_props/gear/chestrigs/cr_bearing.mdl")
ITEM.category = "Разгрузочный жилет"
ITEM.description = "Разгрузочная система предназначенная для переноски магазинов и спецсредств, при одновременном использовании низкопрофильных бронежилетов."
ITEM.Jname = "LBT-1961A"
ITEM.width = 2
ITEM.height = 3
