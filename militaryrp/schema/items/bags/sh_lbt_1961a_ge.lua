ITEM.name = "LBT-1961A GE"
ITEM.model = Model("models/eft_props/gear/chestrigs/cr_lbt_1961_boss.mdl")
ITEM.category = "Разгрузочный жилет"
ITEM.description = "Разгрузочная система, предназначенная для переноски магазинов и спецсредств, при одновременном использовании низкопрофильных бронежилетов. Производство London Bridge Trading. Специальная сборка Birdeye из группы The Goons."
ITEM.Jname = "LBCR GE"
ITEM.width = 2
ITEM.height = 3
