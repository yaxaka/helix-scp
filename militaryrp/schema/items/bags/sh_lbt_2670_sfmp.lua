ITEM.name = "LBT-2670 SFMP"
ITEM.model = Model("models/eft_props/gear/backpacks/bp_medpack.mdl")
ITEM.category = "Рюкзак"
ITEM.description = "Низкопрофильный медицинский рюкзак, предназначенный для переноски большого количества специализированного медицинского оборудования и расходных материалов. Произведено London Bridge Trading."
ITEM.Jname = "LBT-2670 SFMP"
ITEM.width = 5
ITEM.height = 5
