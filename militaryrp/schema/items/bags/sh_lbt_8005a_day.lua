ITEM.name = "LBT-8005A"
ITEM.model = Model("models/eft_props/gear/backpacks/bp_daypack.mdl")
ITEM.category = "Рюкзак"
ITEM.description = "Простой и надежный рюкзак объемом 14 литров в камуфляжной расцветке MultiCam Black. Производитель London Bridge Trading."
ITEM.Jname = "LBT-8005A Day Pack"
ITEM.width = 5
ITEM.height = 5
