ITEM.name = "LolKek 3F Transfer"
ITEM.model = Model("models/eft_props/gear/backpacks/bp_redfox.mdl")
ITEM.category = "Рюкзак"
ITEM.description = "Простой и дешевый рюкзак производства LolKek. Не очень прочный и удобный, но в него можно положить добычу, а это все, что нужно от рюкзака."
ITEM.Jname = "LolKek 3F"
ITEM.width = 4
ITEM.height = 4
