ITEM.name = "M4 RSCR"
ITEM.model = Model("models/eft_props/gear/chestrigs/cr_rscr_zulu.mdl")
ITEM.category = "Разгрузочный жилет"
ITEM.description = "Разгрузочная нагрудная система M4 RSCR была разработана как легкая и минималистичная система для переноски самого необходимого. Производство Zulu Nylon Gear."
ITEM.Jname = "M4 RSCR"
ITEM.width = 2
ITEM.height = 3
