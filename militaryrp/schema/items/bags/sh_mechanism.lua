ITEM.name = "Mechanism"
ITEM.model = Model("models/eft_props/gear/backpacks/bp_oakley_mechanism.mdl")
ITEM.category = "Рюкзак"
ITEM.description = "Рюкзак Mechanism Backpack предлагает универсальность и прочную конструкцию, которая подойдет для любого приключения. Прочные металлические зажимы, молнии и застежки-липучки обеспечивают надежное хранение, а открывающийся сверху клапан означает больше места для переноски более крупных предметов. Разнообразие специализированных карманов обеспечивает организацию в стиле милитари и легкий доступ, а мягкие регулируемые плечевые ремни обеспечат комфорт в любой поездке."
ITEM.Jname = "Mechanism"
ITEM.width = 5
ITEM.height = 5
