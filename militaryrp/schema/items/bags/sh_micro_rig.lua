ITEM.name = "Micro Rig"
ITEM.model = Model("models/eft_props/gear/chestrigs/cr_micro_rig_series.mdl")
ITEM.category = "Разгрузочный жилет"
ITEM.description = "Сверх легкая и небольшая разгрузка с необходимым минимумом подсумков."
ITEM.Jname = "MRig"
ITEM.width = 2
ITEM.height = 2
