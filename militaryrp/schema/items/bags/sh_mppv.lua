ITEM.name = "MPPV"
ITEM.model = Model("models/eft_props/gear/chestrigs/cr_patrol.mdl")
ITEM.category = "Разгрузочный жилет"
ITEM.description = "Multi-Purpose Patrol Vest разработан для боевых ситуаций при патрулировании, где нет необходимости в бронежилете. Легкий жилет, с большим количеством подсумков. Производство Velocity Systems."
ITEM.Jname = "MPPV"
ITEM.width = 2
ITEM.height = 3
