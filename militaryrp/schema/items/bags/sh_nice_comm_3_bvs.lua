ITEM.name = "Mystery Ranch NICE COMM 3 BVS"
ITEM.model = Model("models/eft_props/gear/backpacks/bp_mystery_ranch.mdl")
ITEM.category = "Рюкзак"
ITEM.description = "Спецсистема NICE Frame для переноски крупногабаритных или тяжелых грузов с установленным рюкзаком COMM 3 для переноски радиосистем. Основной отсек COMM 3 рассчитан на радиостанции PRC117F или G, PRC119F, 152 или ASIP. Крышка Hitchhiker и Daypack позволяет переносить отдельное снаряжение при необходимости. Модульная система NICE COMM 3 готова адаптироваться под меняющиеся задачи."
ITEM.Jname = "NICE COMM 3 BVS"
ITEM.width = 4
ITEM.height = 4
