ITEM.name = "Paratus"
ITEM.model = Model("models/eft_props/gear/backpacks/bp_paratus_3_day.mdl")
ITEM.category = "Рюкзак"
ITEM.description = "Модульный рюкзак из полиэстера с ПВХ-подкладкой для бойцов."
ITEM.Jname = "Paratus 3-Day"
ITEM.width = 5
ITEM.height = 6
