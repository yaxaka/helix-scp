ITEM.name = "Piligrim"
ITEM.model = Model("models/eft_props/gear/backpacks/bp_piligrimm.mdl")
ITEM.category = "Рюкзак"
ITEM.description = "Большой и яркий рюкзак, который идеально подойдет туристу, отправляющемуся в поход."
ITEM.Jname = "Pilgrim"
ITEM.width = 5
ITEM.height = 6
