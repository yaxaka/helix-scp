...
ITEM.description = "Компактный рюкзак для безопасного хранения хрупких предметов, электроники и других ценностей. Военные модульные стропы (MOLLE) предусмотрены по бокам, на лямках и внутри, а также панели на липучках для расширения с помощью подсумков, нашивок на липучках и т. д. Произведено Hazard 4."
ITEM.Jname = "Pillbox"
ITEM.width = 4
ITEM.height = 4
