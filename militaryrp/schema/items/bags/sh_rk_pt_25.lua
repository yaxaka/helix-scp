ITEM.name = "RK-PT-25"
ITEM.model = Model("models/eft_props/gear/backpacks/bp_tehnikom_patrol.mdl")
ITEM.category = "Рюкзак"
ITEM.description = "Рюкзак представляет собой многофункциональное снаряжение, предназначенное для транспортировки различных предметов боевого и походного снаряжения, дополнительного вооружения и т.п. Может использоваться как в составе транспортно-снаряженийного комплекса, так и самостоятельно, в составе различных комплектов индивидуальной боевой экипировки"
ITEM.Jname = "RK-PT-25"
ITEM.width = 4
ITEM.height = 4
