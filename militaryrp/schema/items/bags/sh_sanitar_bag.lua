ITEM.name = "Санитарная сумка"
ITEM.model = Model("models/eft_props/gear/backpacks/bp_med_bag.mdl")
ITEM.category = "Рюкзак"
ITEM.description = "Медицинская сумка, часто используемая средним и низшим медицинским персоналом, иногда врачами, для переноски инструментов и лекарств."
ITEM.Jname = "Sanitar's Bag"
ITEM.width = 3
ITEM.height = 3
