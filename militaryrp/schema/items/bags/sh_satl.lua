ITEM.name = "SATL"
ITEM.model = Model("models/eft_props/gear/backpacks/bp_mystery_ranch_satl.mdl")
ITEM.category = "Рюкзак"
ITEM.description = "Штурмовой рюкзак Mystery Ranch SATL был стандартным снаряжением для штурмовых операций на протяжении почти десятилетия. Теперь он оснащен съемной системой BVS и перенаправляющим поясным ремнем для эффективного распределения веса, даже когда рюкзак надет поверх бронежилета."
ITEM.Jname = "SATL"
ITEM.width = 5
ITEM.height = 6
