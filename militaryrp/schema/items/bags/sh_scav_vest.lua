ITEM.name = "Scav Vest"
ITEM.model = Model("models/eft_props/gear/chestrigs/cr_vestwild.mdl")
ITEM.category = "Разгрузочный жилет"
ITEM.description = "Рыболовный жилет может в некоторой степени заменить спасательный жилет, если в этом есть острая необходимость."
ITEM.Jname = "Scav Vest"
ITEM.width = 2
ITEM.height = 3
