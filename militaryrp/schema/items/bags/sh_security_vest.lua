ITEM.name = "Security Vest"
ITEM.model = Model("models/eft_props/gear/chestrigs/cr_ctacticall.mdl")
ITEM.category = "Разгрузочный жилет"
ITEM.description = "Самый простой, спасательный жилет спецслужб."
ITEM.Jname = "Security Vest"
ITEM.width = 2
ITEM.height = 3
