ITEM.name = "Sprofi MK2"
ITEM.model = Model("models/eft_props/gear/chestrigs/cr_sprofi_mk2_ak.mdl")
ITEM.category = "Разгрузочный жилет"
ITEM.description = "Разгрузочная система Чест-риг может использоваться как самостоятельный элемент снаряжения, так и дополнением к бронежилетам не имеющих системы MOLLE. Подходит для инструкторов огневой подготовки, сотрудников спецподразделений и любителей тактиеского уничтожения картона. Легкая комплектация для разведчиков в камуфляже A-TACS FG."
ITEM.Jname = "SProfi MK2 A"
ITEM.width = 2
ITEM.height = 3
