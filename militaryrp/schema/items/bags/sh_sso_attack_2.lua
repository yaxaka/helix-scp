ITEM.name = "SSO Attack"
ITEM.model = Model("models/eft_props/gear/backpacks/bp_s_so.mdl")
ITEM.category = "Рюкзак"
ITEM.description = "Рейдовый рюкзак Ataka 2 объемом 60 литров предназначен для переноски личных вещей и снаряжения в сложных полевых условиях."
ITEM.Jname = "SSO Attack 2"
ITEM.width = 5
ITEM.height = 5
