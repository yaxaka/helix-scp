ITEM.name = "Tactical Sling Bag"
ITEM.model = Model("models/eft_props/gear/backpacks/bp_tactical_backpack.mdl")
ITEM.category = "Рюкзак"
ITEM.description = "Оригинальная сумка-слинг для повседневной носки или активного отдыха."
ITEM.Jname = "Tactical Sling Bag"
ITEM.width = 3
ITEM.height = 3
