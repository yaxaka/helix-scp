ITEM.name = "Takedown"
ITEM.model = Model("models/eft_props/gear/backpacks/bp_takedown_sling.mdl")
ITEM.category = "Рюкзак"
ITEM.description = "Однолямочный рюкзак, предназначенный для переноски длинноствольного оружия. Дополнительные внешние карманы предназначены для переноски магазинов, набора для чистки или дополнительных деталей. Производитель Hazard 4."
ITEM.Jname = "Takedown Black"
ITEM.width = 2
ITEM.height = 4
...
ITEM.iconCam = {
	pos = Vector(513.64, 430.61, 310.24),
	ang = Angle(25, 220, 0),
	fov = 2
}
