ITEM.name = "Tarzan"
ITEM.model = Model("models/eft_props/gear/chestrigs/cr_tarzan.mdl")
ITEM.category = "Разгрузочный жилет"
ITEM.description = "Простая и достаточно удобная разгрузка образца 2002 года. Активно используется до сих пор как охранными и силовыми структурами, так и гражданскими стрелками."
ITEM.Jname = "Tarzan"
ITEM.width = 2
ITEM.height = 3
