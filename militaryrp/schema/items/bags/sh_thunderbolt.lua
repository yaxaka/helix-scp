...
ITEM.model = Model("models/eft_props/gear/chestrigs/cr_thunderbolt.mdl")
ITEM.category = "Разгрузочный жилет"
ITEM.description = "Фиксированная разгрузочная система от компании Direct Action, содержащая все базовые необходимые подсумки."
ITEM.Jname = "Thunderbolt"
ITEM.width = 2
ITEM.height = 3
