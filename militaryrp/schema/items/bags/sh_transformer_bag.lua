ITEM.name = "Сумка-трансформер"
ITEM.model = Model("models/eft_props/gear/backpacks/bp_max_fuchs.mdl")
ITEM.category = "Рюкзак"
ITEM.description = "Довольно просторная сумка-мессенджер, достаточно большая, чтобы вместить ланч-бокс, ноутбук и несколько бумаг - или небольшой аварийный набор для выживания. Трансформируемый ремень и универсальный размер позволяют носить ее и как сумку, и как компактный рюкзак."
ITEM.Jname = "Transformer Bag"
ITEM.width = 3
ITEM.height = 3
