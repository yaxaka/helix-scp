ITEM.name = "Tri-Zip"
ITEM.model = Model("models/eft_props/gear/backpacks/bp_trizip.mdl")
ITEM.category = "Рюкзак"
ITEM.description = "Универсальный штурмовой рюкзак среднего размера. Просторный, прочный и удобный, этот рюкзак любят как военные, так и туристы по всему миру. 34 л общего объема, питьевая система, легкий доступ к боковым карманам, почти идеальная подвеска и система крепления MOLLE делают его отличным выбором для автономного похода продолжительностью до 72 часов... или переноски большого количества добычи."
ITEM.Jname = "Tri-Zip"
ITEM.width = 4
ITEM.height = 4
