ITEM.name = "Trooper 35"
ITEM.model = Model("models/eft_props/gear/backpacks/bp_trooper_35.mdl")
ITEM.category = "Рюкзак"
ITEM.description = "TT Trooper Light Pack 35 — легкий и функциональный рюкзак объемом 35 литров от Tasmanian Tiger с удобной и эргономичной системой подвески PaddenBack и анатомическими плечевыми ремнями."
ITEM.Jname = "TT Trooper 35"
ITEM.width = 5
ITEM.height = 5
