ITEM.name = "Type 56 Chicom"
ITEM.model = Model("models/eft_props/gear/chestrigs/cr_chicom.mdl")
ITEM.category = "Разгрузочный жилет"
ITEM.description = "Разгрузочный жилет тип 56 “Чи-Ком” является прародителем современных тактических разгрузочных систем. Нагрудник для магазинов автомата тип 56 был разработан для Народно-освободительной армии Китая в 1950-х годах и с тех пор широко использовался во многих локальных конфликтах XX века. В начале 1980-х годов такие нагрудники попали в Афганистан, где получили признание у отдельных военнослужащих ОКСВА, которые использовали трофейные Чи-Ком. Неизвестно, послужил или нет Чи-Ком прообразом советского нагрудника Пояс-А."
ITEM.Jname = "Chicom"
ITEM.width = 2
ITEM.height = 3
