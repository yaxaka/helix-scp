ITEM.name = "Umka M33-SET1"
ITEM.model = Model("models/eft_props/gear/chestrigs/cr_umka_m33.mdl")
ITEM.category = "Разгрузочный жилет"
ITEM.description = "Жилет Умка М33-SET1 разработан для охотников, путешественников, профессионалов полевых профессий и профессионалов безопасности."
ITEM.Jname = "Umka"
ITEM.width = 2
ITEM.height = 3
