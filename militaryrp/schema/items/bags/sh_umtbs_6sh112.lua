ITEM.name = "UMTBS 6sh112"
ITEM.model = Model("models/eft_props/gear/chestrigs/cr_6h112.mdl")
ITEM.category = "Разгрузочный жилет"
ITEM.description = "Универсальная модульная транспортно-боевая система (УМТБС) «Разведчик-стрелок». Жилет изготовлен по модульной технологии в нескольких комплектациях для конкретной боевой задачи. Данная система включает в себя жилетную основу, подсумки различного назначения и ранцы. За счёт того, что жилетная основа изготовлена на базе системы MOLLE, к ней можно крепить различные совместимые подсумки помимо тех, что есть в комплекте. В поясном ремне системы имеются мягкие амортизирующие вставки, а внутри она выполнена из вентилируемого материала."
ITEM.Jname = "UMTBS 6sh112"
ITEM.width = 2
ITEM.height = 3
