ITEM.name = "Армейский мешок ВКБО"
ITEM.model = Model("models/eft_props/gear/backpacks/bp_vkbo.mdl")
ITEM.category = "Рюкзак"
ITEM.description = "Входит в состав всесезонного комплекта основного снаряжения (ВКБО). Предназначен для транспортировки и хранения личных вещей военнослужащих."
ITEM.Jname = "VKBO Army Bag"
ITEM.width = 3
ITEM.height = 4
