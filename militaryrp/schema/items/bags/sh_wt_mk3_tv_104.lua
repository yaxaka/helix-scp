ITEM.name = "WT MK3 TV-104"
ITEM.model = Model("models/eft_props/gear/chestrigs/cr_mk3.mdl")
ITEM.category = "Разгрузочный жилет"
ITEM.description = "Нагрудный разгрузочный жилет - это платформа предназначенная для размещения снаряжения в области груди живота, имеющая при этом открытую спину. Интегрированные подсумки, рассчитаны на 8 магазинов.Может использоваться как отдельно, так и поверх бронежилета."
ITEM.Jname = "MK3 Chest Rig"
ITEM.width = 2
ITEM.height = 3
