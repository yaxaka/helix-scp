ITEM.name = "WT TV-109"
ITEM.model = Model("models/eft_props/gear/chestrigs/cr_tv109.mdl")
ITEM.category = "Разгрузочный жилет"
ITEM.description = "Тяжелая подвесная система TV-109 предназначены для крепления на пояс, с целью разгрузить часть веса на плечи. Плечи усилены пенкой и имеют стропы MOLLE, для перевода пояса в комплекте с этой системой в полноценную РПС."
ITEM.Jname = "TV-109"
ITEM.width = 2
ITEM.height = 3
